...
// Common clockwork domain errors. Use `ErrX.WithCausef()` to clone and add context.
var (
...
// Error represents any error returned by the Clockwork components along with any
// relevant context.
type Error struct {
...
func (err Error) WithCausef(msg string, args ...any) Error {
	cloned := err
...
func (err Error) WithMsgf(msg string, args ...any) Error {
	cloned := err
